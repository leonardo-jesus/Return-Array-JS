...
The ***Return Array***,  is a Project that **Return the Array selected objects**. With the purpose of training ***Script***, ***Array Access*** and ***Array Propeties***, using ***Loop***. Made with **Javascript**.
